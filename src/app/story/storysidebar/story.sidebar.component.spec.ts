...
describe('StorysidebarComponent testing', () => {
  ...
  it('should display the input node when the sidebar is open', fakeAsync(() => {
    ...
    expect(sidebarPropertiesEl.children[3].children[1].textContent.trim()).toBe('March 5, 2018, 20:29:03 UTC');
    expect(sidebarPropertiesEl.children[4].children[0].textContent).toBe('ID');
    expect(sidebarPropertiesEl.children[4].children[1].textContent.trim()).toBe('23456');
    expect(sidebarPropertiesEl.children[5].children[0].textContent).toBe('Modified Time');
    expect(sidebarPropertiesEl.children[5].children[1].textContent.trim()).toBe('March 26, 2018, 15:53:52 UTC');
    expect(sidebarPropertiesEl.children[6].children[0].textContent).toBe('Priority');
    expect(sidebarPropertiesEl.children[6].children[1].textContent.trim()).toBe('high');
    expect(sidebarPropertiesEl.children[7].children[0].textContent).toBe('Product Name');
    expect(sidebarPropertiesEl.children[7].children[1].textContent.trim()).toBe('Red Hat Enterprise Linux 7');
    expect(sidebarPropertiesEl.children[8].children[0].textContent).toBe('Product Version');
    expect(sidebarPropertiesEl.children[8].children[1].textContent.trim()).toBe('7.4');
    ...
    expect(sidebarPropertiesEl.children[12].children[1].textContent.trim()).toBe('ERRATA');
    ...
    expect(sidebarPropertiesEl.children[16].children[1].textContent.trim().length).toBe(151);
    expect(sidebarPropertiesEl.children[17].children[0].textContent).toBe('Status');
    expect(sidebarPropertiesEl.children[17].children[1].textContent.trim()).toBe('CLOSED');
    expect(sidebarPropertiesEl.children[18].children[0].textContent).toBe('Target Milestone');
    expect(sidebarPropertiesEl.children[18].children[1].textContent.trim()).toBe('rc');
    expect(sidebarPropertiesEl.children[19].children[0].textContent).toBe('Votes');
    expect(sidebarPropertiesEl.children[19].children[1].textContent.trim()).toBe('0');
  }));
